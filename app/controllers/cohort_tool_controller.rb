...
=begin
		...
		@resuscination["Ward 1A"] = short_stay_ward("Ward 1A", "transfer out", sresuscination, @start_time, @end_time)
		@resuscination["Ward 2A"] = short_stay_ward("Ward 2A", "transfer out", resuscination, @start_time, @end_time)
=end
