...
EOF
  ...
  def self.get_patient(person)
    ...
    patient.current_residence = person.addresses.first.city_village
		patient.current_district = person.addresses.first.state_province rescue ''
    ...
    patient.cell_phone_number = self.get_attribute(person, 'Cell phone number') rescue nil
    patient.office_phone_number = self.get_attribute(person, 'Office phone number') rescue nil
    patient.home_phone_number = self.get_attribute(person, 'Home phone number') rescue nil
